# create and run an ExtJS app

1. Install SenchaCmd
2. In terminal navigate to directory where you want to create your app
3. Type (./MyApp gets generated as a folder in the current folder)
   sencha generate app --ext MyApp ./MyApp

Start MyApp with VS code:
1. cd .\MyApp
2. sencha app watch

View app at http://localhost:1841/
...
This area is intended for overrides like these:
    ...
    Ext.define('wizzardApp.overrides.foo.Bar', {
